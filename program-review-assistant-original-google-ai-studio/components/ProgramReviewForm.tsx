  ...
  return (
    <div className="space-y-8">
      <div className="p-6 bg-white rounded-lg shadow-md border border-slate-200">
        <h2 className="text-2xl font-semibold text-slate-800">Review for: <span className="text-blue-600">{programName} Program</span></h2>
        <p className="mt-2 text-slate-600">
          Complete each section below. You can write your own thoughts or use the AI Assistant to help you draft content based on the program's data.
        </p>
      </div>
      ...
      <div className="mt-8 p-6 bg-white rounded-lg shadow-md border border-slate-200">
        <h3 className="text-xl font-semibold text-slate-800 mb-2">Finalize Your Review</h3>
        <p className="text-slate-500 mb-4">Once you have completed all sections, you can export the full document or generate an executive summary.</p>
